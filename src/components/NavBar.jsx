...
const NavBar = ({darkTheme, setDarkTheme}) => {
  return (
    ...
    <Link to="/">
      <p className="text-2xl bg-blue-500 text-white py-1 px-2 rounded 
      dark:bg-gray-500 dark:text-gray-900 ">
        Google 🔎
      </p>
    </Link>
    <button type='button' onClick={()=>setDarkTheme(!darkTheme)} 
      className="text-xl dark:bg-gray-50 dark:text-gray-900 bg-white border 
      rounded-full first-letter px-2 py-1 hover:shadow-lg">
